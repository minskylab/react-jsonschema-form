...
var utils = require('@rjsf/core/lib/utils');
...
var TitleField = function TitleField(_ref) {
  ...
  return React.createElement(react.Box, {
    ...
    size: "md",
    mt: 6
  }, title), React.createElement(react.Divider, null));
};
...
var FieldTemplate = function FieldTemplate(_ref) {
  ...
  return React.createElement(react.FormControl, {
    ...
    return (// eslint-disable-next-line react/no-array-index-key
      React.createElement(react.FormErrorMessage, {
        key: i,
        id: id
      }, error)
    );
  }), rawHelp && React.createElement(react.FormHelperText, {
    id: id
  }, rawHelp));
};
...
var AddButton = function AddButton(props) {
  return React.createElement(react.Button, Object.assign({
    ...
    fontWeight: "500",
    size: "sm",
    leftIcon: React.createElement(md.MdAdd, null)
...
var mappings = {
  remove: /*#__PURE__*/React.createElement(md.MdRemove, null),
  plus: /*#__PURE__*/React.createElement(md.MdAdd, null),
  "arrow-up": /*#__PURE__*/React.createElement(md.MdArrowUpward, null),
  "arrow-down": /*#__PURE__*/React.createElement(md.MdArrowDownward, null)
};
...
var MyIconButton = function MyIconButton(_ref) {
  ...
  //@ts-ignore
  return React.createElement(react.IconButton, Object.assign({}, otherProps, {
    size: "sm",
    icon: (_mappings$iconMap = mappings[iconMap]) !== null && _mappings$iconMap !== void 0 ? _mappings$iconMap : React.createElement(md.MdAdd, null)
  }));
};
...
var ArrayFieldTemplate = function ArrayFieldTemplate(props) {
  ...
  if (utils.isMultiSelect(schema, registry.rootSchema)) {
...
var ArrayFieldTitle = function ArrayFieldTitle(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(react.Divider, {
    mb: 3
...
var DefaultArrayItem = function DefaultArrayItem(_ref3) {
  ...
  return React.createElement(react.Flex, {
    ...
    py: 1,
    mb: 1
  }, children), hasToolbar && React.createElement(react.Flex, {
...
var DefaultNormalArrayFieldTemplate = function DefaultNormalArrayFieldTemplate(_ref5) {
  ...
  }), canAdd && React.createElement(react.Flex, {
    justify: "flex-end"
  }, React.createElement(react.Box, {
    mt: 2
...
var ErrorList = function ErrorList(_ref) {
  ...
  return React.createElement(react.Box, {
    ...
    fontWeight: "500",
    color: "red.600"
  }, "Errors"), React.createElement(react.List, {
    spacing: 2
  }, errors.map(function (error, i) {
    return React.createElement(react.ListItem, {
      key: i
    }, React.createElement(react.ListIcon, {
      icon: "warning-2"
    }), error.stack);
  })));
};
...
var BaseInput = function BaseInput(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(react.Input, Object.assign({
    key: inputProps.id,
...
var CheckboxesWidget = function CheckboxesWidget(_ref) {
  ...
  return React.createElement(react.CheckboxGroup, {
    ...
    return React.createElement(react.Checkbox, {
      key: id + "_" + index,
      id: id + "_" + index,
      value: option.value,
      isChecked: checked,
...
var RadioWidget = function RadioWidget(_ref) {
  ...
  return React.createElement(react.FormControl, {
    required: required
  }, React.createElement(react.RadioGroup, {
    name: name,
    value: "" + value,
    isInline: inline,
    onChange: _onChange,
    ...
    var itemDisabled = enumDisabled && enumDisabled.indexOf(option.value) !== -1;
    return (// eslint-disable-next-line react/no-array-index-key
      React.createElement(react.Radio, {
        value: "" + option.value,
        key: i,
        pr: paddingRatio,
        isDisabled: disabled || itemDisabled || readonly
...
var RangeWidget = function RangeWidget(_ref) {
  ...
  return React.createElement(react.Slider, Object.assign({}, sliderProps, {
    isDisabled: disabled || readonly,
    onChange: _onChange,
    onBlur: _onBlur,
    onFocus: _onFocus
  }), React.createElement(react.SliderTrack, null), React.createElement(react.SliderFilledTrack, null), React.createElement(react.SliderThumb, null));
};
...
function SelectWidget(props) {
  ...
  return React.createElement(react.Select, {
    id: id,
    multiple: multiple,
...
var TextareaWidget = function TextareaWidget(_ref) {
  ...
  return React.createElement(react.Textarea, {
    id: id,
    value: value,
...
var UpDownWidget = function UpDownWidget(_ref) {
  ...
  return React.createElement(react.NumberInput, {
    id: id,
    isDisabled: disabled || readonly,
    value: value,
    onChange: _onChange,
    onBlur: _onBlur,
    onFocus: _onFocus
  }, React.createElement(react.NumberInputField, null), React.createElement(react.NumberInputStepper, null, React.createElement(react.NumberIncrementStepper, null), React.createElement(react.NumberDecrementStepper, null)));
};
